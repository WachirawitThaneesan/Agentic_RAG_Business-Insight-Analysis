...
_SQL_TERMS: Dict[str, int] = {
    ...
    # EAV attribute questions (business type / share count) — phrasing varies,
    # so match the verbs too ("ประกอบธุรกิจประเภทใด" reverses "ประเภทธุรกิจ").
    "ประกอบธุรกิจ": 4, "ธุรกิจประเภท": 4, "ธุรกิจอะไร": 4, "กี่หุ้น": 4,
}
...
_VECTOR_TERMS: Dict[str, int] = {
    ...
    "หน้าที่": 3, "อธิบาย": 2, "สาเหตุ": 2, "ทำไม": 2, "เพราะเหตุใด": 3,
    "อย่างไร": 2, "ปัจจัยความเสี่ยง": 3, "ความเสี่ยง": 2, "รางวัล": 3,
    "หลักการ": 2, "แผนงาน": 2, "การกำกับดูแล": 2,
    # governance / narrative report content (committees, meetings, training,
    # ratings, awards) — these live in prose chunks, not the SQL warehouse.
    "คณะกรรมการ": 3, "กรรมการ": 2, "ประชุม": 2, "อบรม": 3, "ประเมินผล": 3,
    "ประเมินตนเอง": 3, "จัดอันดับ": 3, "ความน่าเชื่อถือ": 3, "ได้รับรางวัล": 4,
    "e-agm": 4, "สตาร์ทอัพ": 3, "เทรนด์": 3, "มุ่งเน้น": 2, "สนับสนุน": 2,
}
